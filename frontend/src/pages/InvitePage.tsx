// InvitePage — landing page for invite links (/invite?token=<uuid>)
// Shown to uninvited users before they sign in with Google.
...
export function InvitePage() {
  ...
  useEffect(() => {
    ...
    invitesApi
      .verify(token)
      .then((res) => setState({ phase: "valid", email: res.email }))
