...
export function WatchdogWidget() {
  ...
  return (
    <div className="rounded-xl border border-amber-200/60 dark:border-amber-800/60 bg-amber-50/80 dark:bg-amber-950/80 shadow-sm shadow-amber-100/50 dark:shadow-amber-900/50 overflow-hidden">
      {/* Header */}
      <button
        onClick={() => setOpen((v) => !v)}
        className="flex w-full items-center justify-between px-4 py-3
                   hover:bg-amber-100/50 dark:hover:bg-amber-900/50 transition-colors"
      >
        <div className="flex items-center gap-2">
          ...
          <span className="rounded-full bg-amber-200 dark:bg-amber-800 px-1.5 py-0.5 text-xs font-medium text-amber-800 dark:text-amber-200">
            {tasks.length}
          </span>
        </div>
        <svg
          className={clsx(
            "w-4 h-4 text-amber-500 dark:text-amber-400 transition-transform",
            open && "rotate-180"
          )}
          viewBox="0 0 16 16"
          fill="currentColor"
    ...
    <div className="px-4 py-3 space-y-2">
      <div className="flex items-start gap-2">
        <div className="flex-1 min-w-0">
          <p className="text-sm text-gray-800 dark:text-gray-100 font-medium leading-snug">{title}</p>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="rounded-lg bg-red-600 px-3 py-1 text-xs font-medium text-white
                       hover:bg-red-700 active:scale-[0.97] disabled:opacity-50
          ...
          <button
            ...
            className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-1 text-xs
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="rounded-lg bg-emerald-600 px-3 py-1.5 text-xs font-medium text-white
                       hover:bg-emerald-700 active:scale-[0.97] disabled:opacity-50
                       transition-all duration-150"
          >
          ...
          <button
            ...
            disabled={isBusy}
            className="rounded-lg border border-amber-300 dark:border-amber-700 bg-white dark:bg-gray-800 px-3 py-1.5 text-xs
                       text-gray-700 dark:text-gray-200 hover:bg-amber-50 dark:hover:bg-amber-950 disabled:opacity-50 transition-colors"
          >
