/**
 * LoginScreen — shown when no session cookie is present.
 * Single CTA: Sign in with Google (work account OAuth flow).
 */
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-8 text-center">
        ...
        {/* Sign in card */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/60 dark:border-gray-700/60 shadow-sm shadow-gray-200/50 dark:shadow-black/30 p-8 space-y-5">
        ...
        <p className="text-xs text-gray-400 dark:text-gray-500">
          Work account only. Personal calendar access is connected after login.
        </p>
      </div>
    </div>
  );
